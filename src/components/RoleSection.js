      ...
      <section className="py-10 px-5">
        <div className="max-w-3xl mx-auto text-center">
          <div className="flex flex-wrap justify-center gap-3 mb-4">
            ...
            <a href="/career-opportunities/" className="btn-outline">View All Roles</a>
          </div>
          <p className="text-[10px] text-surface-muted">Detailed compensation, contracts, and payout systems will be managed on Mundus.Center after recognition.</p>
        </div>
      </section>
    </>
  );
