    ...
    <>
      ...
      <section className="py-12 px-5 bg-navy-900">
        <div className="max-w-3xl mx-auto text-center">
          <p className="section-label justify-center">Detailed Compensation Lives On</p>
          <h2 className="font-display text-2xl md:text-3xl font-medium tracking-tight mb-3">
            <em className="text-gold italic">Mundus.Center</em>
          </h2>
          <p className="text-sm text-surface-secondary mb-5 max-w-2xl mx-auto">
            Simulators on Economic Empowerment show illustrative ecosystem activity. Actual compensation, contracts, coordinator rankings, payout systems, and processor requirements are managed on Mundus.Center.
          </p>
